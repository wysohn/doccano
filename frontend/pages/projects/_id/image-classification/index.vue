...
export default {
  ...
  methods: {
    async list(imageId) {
      this.annotations = await this.$services.textClassification.list(
        this.projectId,
        imageId
      );
    },
    ...
    async remove(id) {
      await this.$services.textClassification.delete(
        this.projectId,
        this.image.id,
        id
      );
    ...
    async add(labelId) {
      await this.$services.textClassification.create(
        this.projectId,
        this.image.id,
        labelId
      );
    ...
    async clear() {
      await this.$services.textClassification.clear(
        this.projectId,
        this.image.id
      );
      await this.list(this.image.id);
    ...
    async autoLabel(imageId) {
      try {
        await this.$services.textClassification.autoLabel(
          this.projectId,
          imageId
        );
      } catch (e) {
